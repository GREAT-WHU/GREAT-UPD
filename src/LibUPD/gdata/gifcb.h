...
namespace great
{
	...
	*/
	class UPD_LIBRARY_EXPORT t_ifcbrec
	{
	public:
	...
	/** 
	*@brief map container using satellite name as a index for storaging t_ifcbrec ptr , one epoch/all satellite
	*       for wide-lane only one sign epoch "WL_IDENTIFY"   
	*/
	typedef map<string, shared_ptr<t_ifcbrec>> GNUT_LIBRARY_EXPORT one_epoch_ifcb;

	/**
	*@brief	 Class for storaging all epoch/all satellite ifcb data
	*/
	class UPD_LIBRARY_EXPORT t_gifcb : public t_gdata
	{
	public:
